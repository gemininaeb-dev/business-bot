...
### Дашборд
Сводка по клиентам, заявкам и выручке с анимированными счётчиками.

![Дашборд](docs/screenshots/dashboard.png)

### Заявки и карточка заявки
Фильтрация по статусам, состав заказа, данные клиента, смена статуса в один клик.

| Список заявок | Карточка заявки |
|:---:|:---:|
| ![Заявки](docs/screenshots/orders.png) | ![Карточка заявки](docs/screenshots/order_detail.png) |

### Каталог и рассылка
| Управление каталогом | Массовая рассылка |
|:---:|:---:|
| ![Каталог](docs/screenshots/products.png) | ![Рассылка](docs/screenshots/broadcast.png) |

### Адаптивность и вход
Панель полностью адаптивна — корректно работает на телефоне.

| Мобильная версия | Страница входа |
|:---:|:---:|
| <img src="docs/screenshots/mobile_dashboard.png" width="260"> | <img src="docs/screenshots/login.png" width="420"> |
